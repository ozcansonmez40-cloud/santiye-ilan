...
export const CITY_DISTRICTS: Record<string, string[]> = {
  ...
  "Samsun": ["19 Mayıs","Alaçam","Asarcık","Atakum","Ayvacık","Bafra","Canik","Çarşamba","İlkadım","Kavak","Ladik","Salıpazarı","Tekkeköy","Terme","Vezirköprü","Yakakent"],
  ...
  "Trabzon": ["Akçaabat","Araklı","Arsin","Beşikdüzü","Çarşıbaşı","Çaykara","Dernekpazarı","Düzköy","Hayrat","Köprübaşı","Maçka","Merkez","Of","Ortahisar","Şalpazarı","Tonya","Vakfıkebir","Yomra"],
...
export const TURKISH_CITIES = Object.keys(CITY_DISTRICTS).sort((a, b) =>
